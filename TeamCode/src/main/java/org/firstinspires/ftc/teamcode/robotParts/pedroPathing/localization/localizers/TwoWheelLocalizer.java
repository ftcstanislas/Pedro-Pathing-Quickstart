...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = 8192 * 1.37795 * 2 * Math.PI * 0.5089704715;
    public static double STRAFE_TICKS_TO_INCHES = 8192 * 1.37795 * 2 * Math.PI * 0.546365437;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(-1.476, 4.488, 0);
